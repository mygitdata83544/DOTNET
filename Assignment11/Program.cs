namespace Assignment11
{
    ...
    public class WageEmp : Employee
    {
        ...
        // Parameterized constructor
        public WageEmp(string name, bool gender, Date birth, string address, double salary, DepartmentType dept, int hours, int rate)
        ...
        {
            base.Print();
            Console.WriteLine($"Hours Worked: {hours}, Rate per Hour: {rate}");
        }
